...
using TommieDinner.Api.Common.Errors.Http;

namespace TommieDinner.Api.Common.Errors;

public sealed class TommieDinnerProblemDetailsFactory : ProblemDetailsFactory
{
    ...
    public TommieDinnerProblemDetailsFactory(
